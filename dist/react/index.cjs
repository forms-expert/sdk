...
function useForm(options) {
  ...
  const [activeTheme, setActiveTheme] = (0, import_react.useState)(options.theme);
  ...
  const setThemeHandler = (0, import_react.useCallback)(async (themeKey) => {
...
function FormsExpertForm({
  ...
  const formEl = /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "form",
    {
      ...
      children: [
        googleFontUrl && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("link", { rel: "stylesheet", href: googleFontUrl }),
...
function FormFieldInput({
  ...
  if (field.type === "checkbox" || field.type === "toggle" || field.type === "consent") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", alignItems: "flex-start", gap: "0.5rem", marginBottom: fieldSpacing }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
        (field.label || field.type === "consent" && field.consentText) && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { htmlFor: field.name, className: styling.labelClassName, style: { cursor: "pointer", ...consentSize ? { fontSize: consentSize } : {} }, children: [
        ...
        field.type === "consent" && field.consentUrl && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { href: field.consentUrl, target: "_blank", rel: "noopener noreferrer", style: { color: styling.primaryColor, fontSize: "0.75rem", marginTop: "0.125rem", display: "inline-block" }, children: "View policy" }),
        error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { color: styling.errorColor || "#ef4444", fontSize: "0.875rem", marginTop: "0.25rem" }, children: error })
      ] })
    ] });
  }
  const labelEl = field.label ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "label",
    {
      htmlFor: field.name,
