var E={theme:"light",primaryColor:"#3b82f6",backgroundColor:"#ffffff",textColor:"#1f2937",borderRadius:"md",fontSize:"md",buttonStyle:"filled",labelPosition:"top"};function z(r){switch(r){case"none":return"0";case"sm":return"0.125rem";case"md":return"0.375rem";case"lg":return"0.5rem";default:return"0.375rem"}}function P(r){switch(r){case"none":return"0";case"small":return"4px";case"medium":return"8px";case"large":return"12px";case"full":return"9999px";default:return"8px"}}function A(r){switch(r){case"sm":return"0.875rem";case"md":return"1rem";case"lg":return"1.125rem";default:return"1rem"}}function U(r){switch(r){case"small":return"0.75rem";case"large":return"1rem";default:return"0.875rem"}}function M(r){switch(r){case"compact":return"0.5rem";case"relaxed":return"1.5rem";case"spacious":return"2rem";default:return"1rem"}}function I(r){switch(r){case"none":return"0";case"compact":return"1rem";case"relaxed":return"2.5rem";case"spacious":return"3.5rem";default:return"1.5rem"}}function O(r){switch(r){case"compact":return"0.125rem";case"relaxed":return"0.75rem";default:return"0.25rem"}}function B(r){switch(r){case"narrow":return"28rem";case"wide":return"48rem";case"full":return"100%";default:return"36rem"}}function H(r){switch(r){case"left":return"flex-start";case"right":return"flex-end";default:return"center"}}function w(r=E){let e={...E,...r},a=z(e.borderRadius),d=P(e.buttonRadius),l=A(e.fontSize),c=U(e.placeholderFontSize),o=M(e.fieldSpacing),n=I(e.formPadding),m=O(e.labelSpacing),s=B(e.formWidth),i=e.primaryColor,t=e.buttonColor,p=e.fontFamily||"system-ui, -apple-system, sans-serif",u=H(e.buttonAlign),y={small:{px:"0.75rem",py:"0.375rem",fs:"0.875rem"},medium:{px:"1.25rem",py:"0.625rem",fs:"1rem"},large:{px:"1.75rem",py:"0.875rem",fs:"1.125rem"}}[e.buttonSize||"medium"],N=e.buttonPaddingX!=null?`${e.buttonPaddingX}px`:y.px,T=e.buttonPaddingY!=null?`${e.buttonPaddingY}px`:y.py,R=e.buttonFontSize!=null?`${e.buttonFontSize}px`:y.fs,L=e.buttonGradient||(e.buttonStyle==="filled"?i:"transparent");return`
