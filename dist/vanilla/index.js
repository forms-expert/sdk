...
${e.customCss||""}
`.trim()}function k(t){let e=document.createElement("div");return e.textContent=t,e.innerHTML}function Y(t){switch(t){case"small":return"18px";case"large":return"30px";case"extra-large":return"36px";default:return"24px"}}function X(t){switch(t){case"small":return"14px";case"large":return"18px";default:return"16px"}}function y(t,e){return e?`${t} ${e}`:t}function G(t){return t.map(e=>typeof e=="string"?{value:e,label:e}:e)}function J(t){switch(t){case"1/4":return"25%";case"1/3":return"33.333%";case"1/2":return"50%";case"2/3":return"66.666%";case"3/4":return"75%";case"full":return"100%";default:return}}function T(t,e,a,o){let l=document.createElement("div");if(t.type==="heading"){l.className="forms-expert-group";let n=document.createElement("h3");if(n.className="forms-expert-heading",n.style.fontSize=Y(o?.headingSize),n.textContent=t.label||"",l.appendChild(n),t.content){let m=document.createElement("p");m.className="forms-expert-heading-subtitle",m.textContent=t.content,l.appendChild(m)}return l}if(t.type==="divider"){let n=document.createElement("hr");return n.className="forms-expert-divider",n}if(t.type==="paragraph"){l.className="forms-expert-group";let n=t.paragraphFontSize?`${t.paragraphFontSize}px`:X(o?.paragraphSize);if(t.label){let m=document.createElement("p");m.className="forms-expert-paragraph-label",m.style.fontSize=n,m.textContent=t.label,l.appendChild(m)}if(t.content){let m=document.createElement("div");m.className="forms-expert-paragraph",m.style.fontSize=n,m.innerHTML=t.content,l.appendChild(m)}return l}if(t.type==="hidden"){let n=document.createElement("input");return n.type="hidden",n.name=t.name,n.value=String(t.defaultValue??e??""),l.appendChild(n),l.style.display="none",l}if(t.type==="checkbox"||t.type==="toggle"||t.type==="consent"){l.className="forms-expert-checkbox-group";let n=document.createElement("input");n.type="checkbox",n.id=`mira-field-${t.name}`,n.name=t.name,n.className="forms-expert-checkbox",n.checked=!!e,t.required&&(n.required=!0);let m=document.createElement("div"),p=document.createElement("label");p.htmlFor=n.id,p.style.cursor="pointer",t.type==="consent"&&t.consentFontSize&&(p.style.fontSize=`${t.consentFontSize}px`);let s=t.type==="consent"?t.consentText||t.label||t.name:t.label||t.name;if(p.innerHTML=`${k(s)}${t.required?'<span class="forms-expert-required">*</span>':""}`,m.appendChild(p),t.type==="consent"&&t.consentUrl){let r=document.createElement("a");r.href=t.consentUrl,r.target="_blank",r.rel="noopener noreferrer",r.textContent="View policy",r.className="forms-expert-consent-link",m.appendChild(r)}if(l.appendChild(n),l.appendChild(m),a){let r=document.createElement("div");r.className="forms-expert-error-message",r.textContent=a,l.appendChild(r)}return l}if(l.className="forms-expert-group",t.label){let n=document.createElement("label");n.className=`forms-expert-label${o?.labelClassName?" "+o.labelClassName:""}`,n.htmlFor=`mira-field-${t.name}`,n.innerHTML=`${k(t.label)}${t.required?'<span class="forms-expert-required">*</span>':""}`,l.appendChild(n)}let d=document.createElement("div");d.className="forms-expert-input-wrapper";let c;switch(t.type){case"textarea":case"richText":c=document.createElement("textarea"),c.className=y("forms-expert-textarea",o?.fieldClassName),c.value=String(e||""),t.maxLength&&(c.maxLength=t.maxLength);break;case"select":case"dropdown":{let n=document.createElement("div");n.style.position="relative",n.style.width="100%",o?.fieldClassName&&(n.className=o.fieldClassName);let m=document.createElement("button");m.type="button",m.className="forms-expert-select",m.style.display="flex",m.style.alignItems="center",m.style.justifyContent="space-between",m.style.cursor="pointer",m.style.textAlign="left",m.style.width="100%";let p=G(t.options||[]),s=p.find(i=>i.value===String(e||"")),r=document.createElement("span");r.textContent=s?.label||t.placeholder||"Select an option...",!s&&o?.placeholderColor&&(r.style.color=o.placeholderColor),m.appendChild(r);let u=document.createElement("span");u.innerHTML='<svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M3 4.5L6 7.5L9 4.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',u.style.flexShrink="0",u.style.opacity="0.5",m.appendChild(u);let g=document.createElement("div");g.className="forms-expert-select-dropdown",g.style.display="none",p.forEach(i=>{let b=document.createElement("div");b.className="forms-expert-select-option",b.textContent=i.label,String(e||"")===i.value&&b.classList.add("active"),b.addEventListener("mousedown",h=>{h.preventDefault(),f.value=i.value,r.textContent=i.label,o?.placeholderColor&&(r.style.color=""),g.querySelectorAll(".forms-expert-select-option").forEach(x=>x.classList.remove("active")),b.classList.add("active"),g.style.display="none",f.dispatchEvent(new Event("input",{bubbles:!0}))}),g.appendChild(b)}),m.addEventListener("click",()=>{g.style.display=g.style.display==="none"?"block":"none"}),m.addEventListener("blur",()=>{setTimeout(()=>{g.style.display="none"},150)});let f=document.createElement("input");if(f.type="hidden",f.name=t.name,f.value=String(e||""),t.required&&(f.required=!0),n.appendChild(m),n.appendChild(g),n.appendChild(f),d.appendChild(n),a){let i=document.createElement("div");i.className="forms-expert-error-message",i.textContent=a,d.appendChild(i)}return l.appendChild(d),l}case"radio":{let n=document.createElement("div");if(n.className="forms-expert-radio-group",(t.options||[]).forEach(p=>{let s=document.createElement("label");s.className="forms-expert-radio-item";let r=document.createElement("input");r.type="radio",r.name=t.name,r.value=p,r.checked=e===p,s.appendChild(r),s.appendChild(document.createTextNode(` ${p}`)),n.appendChild(s)}),d.appendChild(n),a){let p=document.createElement("div");p.className="forms-expert-error-message",p.textContent=a,d.appendChild(p)}return l.appendChild(d),l}case"multiselect":{let n=document.createElement("div");n.className="forms-expert-multiselect-group";let m=e||[];if((t.options||[]).forEach(s=>{let r=document.createElement("label");r.className="forms-expert-checkbox-item";let u=document.createElement("input");u.type="checkbox",u.name=t.name,u.value=s,u.checked=m.includes(s),r.appendChild(u),r.appendChild(document.createTextNode(` ${s}`)),n.appendChild(r)}),d.appendChild(n),a){let s=document.createElement("div");s.className="forms-expert-error-message",s.textContent=a,d.appendChild(s)}return l.appendChild(d),l}case"rating":{let n=document.createElement("div");n.className="forms-expert-rating";let m=t.ratingMax||5,p=e||0;for(let s=1;s<=m;s++){let r=document.createElement("button");r.type="button",r.className=`forms-expert-rating-star ${s<=p?"active":""}`,r.textContent="\u2605",r.dataset.value=String(s),n.appendChild(r)}if(d.appendChild(n),a){let s=document.createElement("div");s.className="forms-expert-error-message",s.textContent=a,d.appendChild(s)}return l.appendChild(d),l}case"scale":case"opinionScale":{let n=document.createElement("div");n.className="forms-expert-scale";let m=t.min??(t.type==="opinionScale"?0:1),p=t.max??(t.type==="opinionScale"?10:5),s=e;for(let r=m;r<=p;r++){let u=document.createElement("button");u.type="button",u.className=`forms-expert-scale-btn ${s===r?"active":""}`,u.textContent=String(r),u.dataset.value=String(r),n.appendChild(u)}if(d.appendChild(n),t.lowLabel||t.highLabel){let r=document.createElement("div");r.className="forms-expert-scale-labels",r.innerHTML=`<span>${k(t.lowLabel||"")}</span><span>${k(t.highLabel||"")}</span>`,d.appendChild(r)}if(a){let r=document.createElement("div");r.className="forms-expert-error-message",r.textContent=a,d.appendChild(r)}return l.appendChild(d),l}case"slider":{c=document.createElement("input"),c.type="range",c.className="forms-expert-slider",c.min=String(t.min??0),c.max=String(t.max??100),c.step=String(t.step??1),c.value=String(e??t.min??0);break}case"file":{let n=o?.theme==="dark"?"#4b5563":"#d1d5db",m=o?.theme==="dark"?"#9ca3af":"#6b7280",p=o?.primaryColor||"#3b82f6",s=document.createElement("label");s.htmlFor=`mira-field-${t.name}`,s.className="forms-expert-dropzone";let r=document.createElement("input");r.id=`mira-field-${t.name}`,r.name=t.name,r.type="file",r.style.cssText="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0",t.allowedMimeTypes?.length&&(r.accept=t.allowedMimeTypes.join(",")),t.multiple&&(r.multiple=!0),s.appendChild(r);let u=document.createElement("div");u.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="${m}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" x2="12" y1="3" y2="15"/></svg>`,s.appendChild(u);let g=document.createElement("span");if(g.style.cssText="font-size:0.875rem;font-weight:500",g.textContent="Drag & drop a file here, or click to browse",s.appendChild(g),t.allowedMimeTypes?.length){let f=document.createElement("span");f.style.cssText=`font-size:0.75rem;color:${m}`,f.textContent=t.allowedMimeTypes.join(", "),s.appendChild(f)}if(t.maxFileSize){let f=document.createElement("span");f.style.cssText=`font-size:0.75rem;color:${m}`;let i=t.maxFileSize;f.textContent=`Max size: ${i<1048576?`${(i/1024).toFixed(0)} KB`:`${(i/1048576).toFixed(0)} MB`}`,s.appendChild(f)}if(s.addEventListener("dragover",f=>{f.preventDefault(),s.style.borderColor=p,s.style.backgroundColor=o?.theme==="dark"?"rgba(255,255,255,0.08)":"rgba(0,0,0,0.04)"}),s.addEventListener("dragleave",()=>{s.style.borderColor=n,s.style.backgroundColor="transparent"}),s.addEventListener("drop",f=>{f.preventDefault(),s.style.borderColor=n,s.style.backgroundColor="transparent"}),l.appendChild(s),a){let f=document.createElement("div");f.className="forms-expert-error-message",f.textContent=a,l.appendChild(f)}return l}case"currency":{c=document.createElement("input"),c.type="number",c.className=y("forms-expert-input",o?.fieldClassName),c.value=String(e??""),t.min!==void 0&&(c.min=String(t.min)),t.max!==void 0&&(c.max=String(t.max)),c.step=String(t.step||.01);break}case"phone":c=document.createElement("input"),c.type="tel",c.className=y("forms-expert-input",o?.fieldClassName),c.value=String(e||"");break;case"url":c=document.createElement("input"),c.type="url",c.className=y("forms-expert-input",o?.fieldClassName),c.value=String(e||"");break;case"password":c=document.createElement("input"),c.type="password",c.className=y("forms-expert-input",o?.fieldClassName),c.value=String(e||"");break;case"time":c=document.createElement("input"),c.type="time",c.className=y("forms-expert-input",o?.fieldClassName),c.value=String(e||"");break;case"datetime":c=document.createElement("input"),c.type="datetime-local",c.className=y("forms-expert-input",o?.fieldClassName),c.value=String(e||"");break;case"colorPicker":c=document.createElement("input"),c.type="color",c.className="forms-expert-color",c.value=String(e||"#000000");break;case"dateRange":{let n=document.createElement("div");n.className="forms-expert-date-range";let m=e||{},p=document.createElement("input");p.type="date",p.className=y("forms-expert-input",o?.fieldClassName),p.name=`${t.name}.start`,p.value=m.start||"";let s=document.createElement("input");if(s.type="date",s.className=y("forms-expert-input",o?.fieldClassName),s.name=`${t.name}.end`,s.value=m.end||"",n.appendChild(p),n.appendChild(s),d.appendChild(n),a){let r=document.createElement("div");r.className="forms-expert-error-message",r.textContent=a,d.appendChild(r)}return l.appendChild(d),l}case"address":{let n=document.createElement("div");n.className="forms-expert-address";let m=t.addressFields||["street","city","state","zip","country"],p=e||{},s={street:"Street",street2:"Street Line 2",city:"City",state:"State",zip:"ZIP",country:"Country"};if(m.forEach(r=>{let u=document.createElement("input");u.type="text",u.className=y("forms-expert-input",o?.fieldClassName),u.name=`${t.name}.${r}`,u.placeholder=s[r]||r,u.value=p[r]||"",n.appendChild(u)}),d.appendChild(n),a){let r=document.createElement("div");r.className="forms-expert-error-message",r.textContent=a,d.appendChild(r)}return l.appendChild(d),l}case"name":{let n=document.createElement("div");n.className="forms-expert-name";let m=t.nameFields||["first","last"],p=e||{},s={prefix:"Prefix",first:"First Name",middle:"Middle",last:"Last Name",suffix:"Suffix"};if(m.forEach(r=>{let u=document.createElement("input");u.type="text",u.className=y("forms-expert-input",o?.fieldClassName),u.name=`${t.name}.${r}`,u.placeholder=s[r]||r,u.value=p[r]||"",n.appendChild(u)}),d.appendChild(n),a){let r=document.createElement("div");r.className="forms-expert-error-message",r.textContent=a,d.appendChild(r)}return l.appendChild(d),l}case"imageChoice":{let n=document.createElement("div");n.className="forms-expert-image-choice";let m=t.options||[],p=e;if(m.forEach(s=>{let r=document.createElement("button");if(r.type="button",r.className=`forms-expert-image-choice-item ${p===s.value?"active":""}`,r.dataset.value=s.value,s.imageUrl){let g=document.createElement("img");g.src=s.imageUrl,g.alt=s.label,r.appendChild(g)}let u=document.createElement("span");u.textContent=s.label,r.appendChild(u),n.appendChild(r)}),d.appendChild(n),a){let s=document.createElement("div");s.className="forms-expert-error-message",s.textContent=a,d.appendChild(s)}return l.appendChild(d),l}case"ranking":{let n=document.createElement("div");n.className="forms-expert-ranking";let m=t.options||[];if((e||[...m]).forEach((s,r)=>{let u=document.createElement("div");u.className="forms-expert-ranking-item",u.textContent=`${r+1}. ${s}`,u.dataset.value=s,n.appendChild(u)}),d.appendChild(n),a){let s=document.createElement("div");s.className="forms-expert-error-message",s.textContent=a,d.appendChild(s)}return l.appendChild(d),l}case"location":{let n=document.createElement("div");n.className="forms-expert-location";let m=e||{},p=document.createElement("input");p.type="text",p.className=y("forms-expert-input",o?.fieldClassName),p.name=`${t.name}.address`,p.placeholder="Address",p.value=m.address||"",n.appendChild(p);let s=document.createElement("div");s.className="forms-expert-location-coords";let r=document.createElement("input");r.type="number",r.className=y("forms-expert-input",o?.fieldClassName),r.name=`${t.name}.lat`,r.placeholder="Latitude",r.step="any",r.value=m.lat!==void 0?String(m.lat):"";let u=document.createElement("input");if(u.type="number",u.className=y("forms-expert-input",o?.fieldClassName),u.name=`${t.name}.lng`,u.placeholder="Longitude",u.step="any",u.value=m.lng!==void 0?String(m.lng):"",s.appendChild(r),s.appendChild(u),n.appendChild(s),d.appendChild(n),a){let g=document.createElement("div");g.className="forms-expert-error-message",g.textContent=a,d.appendChild(g)}return l.appendChild(d),l}default:c=document.createElement("input"),c.type=t.type==="email"?"email":t.type==="number"?"number":t.type==="date"?"date":"text",c.className=y("forms-expert-input",o?.fieldClassName),c.value=String(e||""),t.type==="number"&&(t.min!==void 0&&(c.min=String(t.min)),t.max!==void 0&&(c.max=String(t.max)),t.step!==void 0&&(c.step=String(t.step)));break}if(c.id=`mira-field-${t.name}`,c.name=t.name,t.placeholder&&"placeholder"in c&&(c.placeholder=t.placeholder),t.required&&(c.required=!0),a&&c.classList.add("forms-expert-error"),d.appendChild(c),a){let n=document.createElement("div");n.className="forms-expert-error-message",n.textContent=a,d.appendChild(n)}return l.appendChild(d),l}function I(t,e={},a={},o={}){let l=document.createElement("form");if(l.className="forms-expert",o.hideRequiredAsterisk){let i=document.createElement("style");i.textContent=".forms-expert .forms-expert-required { display: none; }",l.appendChild(i)}if(o.showFormName!==!1&&o.formName){let i=document.createElement("h1");i.className="forms-expert-title",i.textContent=o.formName,i.style.fontSize=o.formNameFontSize!=null?`${o.formNameFontSize}px`:"1.5rem";let b={normal:"400",medium:"500",semibold:"600",bold:"700"};i.style.fontWeight=b[o.formNameFontWeight||"bold"]||"700",i.style.marginBottom="0.5rem",l.appendChild(i)}let d=t.styling,c=t.fields,n=d?.buttonAlign==="inline",m=document.createElement("div");n&&(m.style.flex="1 1 0",m.style.minWidth="180px");let p=0;for(;p<c.length;){let i=c[p];if(i.row!=null){let b=[i],h=p+1;for(;h<c.length&&c[h].row===i.row;)b.push(c[h]),h++;if(b.length>1){let x=document.createElement("div");x.style.display="flex",x.style.gap="0.75rem",x.style.flexWrap="wrap",b.forEach(C=>{let w=document.createElement("div"),E=J(C.width);E?w.style.flex=`0 0 calc(${E} - 0.75rem)`:w.style.flex="1 1 0",w.style.minWidth="180px";let N=T(C,e[C.name],a[C.name],d);w.appendChild(N),x.appendChild(w)}),m.appendChild(x)}else{let x=T(i,e[i.name],a[i.name],d);m.appendChild(x)}p=h}else{let b=T(i,e[i.name],a[i.name],d);m.appendChild(b),p++}}if(l.appendChild(m),o.honeypot){let i=document.createElement("input");i.type="text",i.name="_hp",i.className="forms-expert-honeypot",i.tabIndex=-1,i.autocomplete="off",l.appendChild(i)}let s=document.createElement("input");s.type="hidden",s.name="pageUrl",s.value=typeof window<"u"?window.location.href:"",l.appendChild(s);let r=document.createElement("div");r.className="forms-expert-button-wrapper";let u=document.createElement("button");if(u.type="submit",u.className=y("forms-expert-button",o.buttonClassName),u.disabled=o.isLoading||!1,o.isLoading)u.innerHTML=`
      <span class="forms-expert-button-loading">
        <span class="forms-expert-spinner"></span>
        Submitting...
      </span>
    `;else{let i=d?.buttonIcon,b=d?.buttonIconPosition||"left";if(i){u.style.display="inline-flex",u.style.alignItems="center",u.style.gap="0.5rem";let h=document.createElement("span");h.style.display="inline-flex",h.style.flexShrink="0",h.innerHTML=i;let x=document.createElement("span");x.textContent=o.submitText||"Submit",b==="right"?(u.appendChild(x),u.appendChild(h)):(u.appendChild(h),u.appendChild(x))}else u.textContent=o.submitText||"Submit"}let g=o.secondaryButton,f=()=>{if(!g?.enabled)return null;let i=document.createElement("a");if(i.className="forms-expert-secondary-btn",i.href=g.href||"#",i.style.display="inline-flex",i.style.alignItems="center",i.style.gap="0.5rem",g.icon){let x=document.createElement("span");x.style.display="inline-flex",x.style.flexShrink="0",x.innerHTML=g.icon;let C=document.createElement("span");C.textContent=g.text||"Learn More",g.iconPosition==="right"?(i.appendChild(C),i.appendChild(x)):(i.appendChild(x),i.appendChild(C))}else i.textContent=g.text||"Learn More";g.openInNewTab&&(i.target="_blank",i.rel="noopener noreferrer");let b=d?.primaryColor||"#3b82f6",h=g.color||b;return g.style==="filled"?(i.style.background=h,i.style.color=g.textColor||"#ffffff",i.style.border="none"):g.style==="outlined"?(i.style.background="transparent",i.style.color=g.textColor||h,i.style.border=`2px solid ${h}`):g.style==="link"?(i.style.background="transparent",i.style.color=g.textColor||h,i.style.border="none",i.style.textDecoration="underline"):(i.style.background="transparent",i.style.color=g.textColor||h,i.style.border="none"),g.marginTop!=null&&(i.style.marginTop=`${g.marginTop}px`),g.marginBottom!=null&&(i.style.marginBottom=`${g.marginBottom}px`),g.fontSize!=null&&(i.style.fontSize=`${g.fontSize}px`),i};if(g?.enabled&&g.position==="left"){let i=f();i&&r.appendChild(i)}if(r.appendChild(u),g?.enabled&&g.position!=="left"&&g.position!=="below"){let i=f();i&&(i.style.marginLeft="auto",r.appendChild(i))}if(n){r.style.marginTop="0",l.removeChild(m);let i=document.createElement("div");i.style.display="flex",i.style.alignItems="flex-end",i.style.gap="0.75rem",i.style.flexWrap="wrap",i.appendChild(m),i.appendChild(r),l.appendChild(i)}else l.appendChild(r);if(g?.enabled&&g.position==="below"){let i=document.createElement("div");i.className="forms-expert-secondary-below";let b=g.align||o.buttonAlign||"left";i.style.justifyContent=b==="center"?"center":b==="right"?"flex-end":"flex-start",g.marginTop!=null&&(i.style.marginTop=`${g.marginTop}px`),g.marginBottom!=null&&(i.style.marginBottom=`${g.marginBottom}px`);let h=f();h&&(h.style.marginTop="0",h.style.marginBottom="0",i.appendChild(h)),l.appendChild(i)}if(o.showBranding!==!1){let i=o.brandingText||"Powered by Forms Expert",b=o.brandingUrl||"https://mira.io",h=document.createElement("div");h.className="forms-expert-branding",h.innerHTML=`<a href="${b}" target="_blank" rel="noopener">${i}</a>`,l.appendChild(h)}return l}function B(t){let e=document.createElement("div");return e.className="forms-expert-success",e.innerHTML=`
  ...
  `,e}function M(t){return t.reduce((e,a)=>({...e,[a.field]:a.message}),{})}var S=class extends Error{constructor(a,o,l,d){super(a);this.code=o;this.statusCode=l;this.retryAfter=d;this.name="FormsError"}},v=class extends Error{constructor(a){super("Validation failed");this.errors=a;this.name="FormValidationError"}};var $=class{constructor(e){this.apiKey=e.apiKey,this.resourceId=e.resourceId,this.baseUrl=(e.baseUrl||"https://api.forms.expert/api/v1").replace(/\/$/,"")}buildUrl(e){let a=e.includes("?")?"&":"?";return`${this.baseUrl}${e}${a}token=${encodeURIComponent(this.apiKey)}`}async request(e,a,o){let l=this.buildUrl(a),d=await fetch(l,{method:e,headers:{"Content-Type":"application/json"},body:o?JSON.stringify(o):void 0}),c=await d.json();if(!d.ok)throw new S(c.message||"Request failed",c.code||"UNKNOWN_ERROR",d.status,c.retryAfter);return c}async isActive(e,a){let o=a?`?lang=${encodeURIComponent(a)}`:"";return this.request("GET",`/f/${this.resourceId}/${e}/is-active${o}`)}async validate(e,a){return this.request("POST",`/f/${this.resourceId}/${e}/validate`,{data:a})}async submit(e,a,o){let l=this.buildUrl(`/f/${this.resourceId}/${e}`);return Object.values(a).some(c=>c instanceof File||c instanceof FileList&&c.length>0)||o?.onProgress?this.submitWithFormData(l,a,o):this.request("POST",`/f/${this.resourceId}/${e}`,{data:a,pageUrl:o?.pageUrl||(typeof window<"u"?window.location.href:void 0),captchaToken:o?.captchaToken})}submitWithFormData(e,a,o){return new Promise((l,d)=>{let c=new FormData;for(let[p,s]of Object.entries(a))s instanceof File?c.append(p,s):s instanceof FileList?Array.from(s).forEach(r=>c.append(p,r)):s!=null&&c.append(`data[${p}]`,String(s));let n=o?.pageUrl||(typeof window<"u"?window.location.href:"");n&&c.append("pageUrl",n),o?.captchaToken&&c.append("captchaToken",o.captchaToken);let m=new XMLHttpRequest;o?.onProgress&&m.upload.addEventListener("progress",p=>{p.lengthComputable&&o.onProgress({loaded:p.loaded,total:p.total,percentage:Math.round(p.loaded/p.total*100)})}),m.addEventListener("load",()=>{try{let p=JSON.parse(m.responseText);m.status>=200&&m.status<300?l(p):d(new S(p.message||"Submission failed",p.code||"UNKNOWN_ERROR",m.status,p.retryAfter))}catch{d(new S("Invalid response","PARSE_ERROR",m.status))}}),m.addEventListener("error",()=>{d(new S("Network error","NETWORK_ERROR",0))}),m.addEventListener("abort",()=>{d(new S("Request aborted","ABORTED",0))}),m.open("POST",e),m.send(c)})}async trackView(e){let a=this.buildUrl(`/f/${this.resourceId}/${e}/view`);await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:"{}"}).catch(()=>{})}getResourceId(){return this.resourceId}getBaseUrl(){return this.baseUrl}};var R=class{constructor(e,a,o={}){this.config=null;this.apiClient=e,this.slug=a,this.options=o}async initialize(e){return this.config=await this.apiClient.isActive(this.slug,e),this.options.trackViews&&this.apiClient.trackView(this.slug),this.config}getConfig(){return this.config}isActive(){return this.config?.active??!1}requiresCaptcha(){return this.config?.settings?.captcha?.enabled??!1}getCaptchaProvider(){return this.config?.settings?.captcha?.provider}getSchema(){return this.config?.schema}async validate(e){return this.apiClient.validate(this.slug,e)}async submit(e,a){this.options.onSubmitStart?.();try{if(this.config?.mode==="schema"){let l=await this.validate(e);if(!l.valid)throw this.options.onValidationError?.(l.errors),new v(l.errors)}let o=await this.apiClient.submit(this.slug,e,a);return this.options.onSubmitSuccess?.(o),o}catch(o){throw o instanceof S&&this.options.onSubmitError?.(o),o}}getSuccessMessage(){return this.config?.settings?.successMessage||"Form submitted successfully!"}getRedirectUrl(){return this.config?.settings?.redirectUrl}},F=class{constructor(e){this.apiClient=new $(e)}async isActive(e,a){return this.apiClient.isActive(e,a)}async validate(e,a){return this.apiClient.validate(e,a)}async submit(e,a,o){return this.apiClient.submit(e,a,o)}form(e,a){return new R(this.apiClient,e,a)}async trackView(e){return this.apiClient.trackView(e)}async submitWithRetry(e,a,o){let l=o?.maxRetries??3,d=null;for(let c=0;c<l;c++)try{return await this.submit(e,a,o)}catch(n){if(d=n,n instanceof S){if(["VALIDATION_ERROR","CAPTCHA_REQUIRED","ORIGIN_NOT_ALLOWED"].includes(n.code))throw n;if(n.code.includes("RATE_LIMIT")){let m=n.retryAfter||Math.pow(2,c)*1e3;await new Promise(p=>setTimeout(p,m));continue}}await new Promise(m=>setTimeout(m,Math.pow(2,c)*1e3))}throw d}};var L=class{constructor(e,a){this.config=null;this.values={};this.errors={};this.isLoading=!1;this.isSubmitted=!1;this.styleEl=null;this.sdk=new F(e),this.options=a;let o=a.target;if(typeof o=="string"){let l=document.querySelector(o);if(!l)throw new Error(`Element not found: ${o}`);this.container=l}else this.container=o}async init(){try{if(this.renderLoading(),this.config=await this.sdk.isActive(this.options.slug,this.options.lang),!this.config.active){this.renderError("This form is not available");return}this.options.trackViews&&this.sdk.trackView(this.options.slug),this.injectStyles(),this.render()}catch(e){this.renderError("Failed to load form"),this.options.onError?.(e)}}injectStyles(){if(this.styleEl)return;this.styleEl=document.createElement("style"),this.styleEl.id=`forms-expert-styles-${this.options.slug}`;let e={...this.config?.schema?.styling,...this.config?.styling};this.styleEl.textContent=P(e),document.head.appendChild(this.styleEl),this.injectGoogleFont(e?.fontFamily)}injectGoogleFont(e){if(!e)return;let a=["Inter","Roboto","Open Sans","Lato","Poppins","Montserrat","Nunito","Source Sans Pro","Raleway","Ubuntu","Playfair Display","Merriweather"],o=e.split(",")[0]?.trim();if(!o||!a.includes(o))return;let l=`forms-expert-font-${this.options.slug}`;if(document.getElementById(l))return;let d=document.createElement("link");d.id=l,d.rel="stylesheet",d.href=`https://fonts.googleapis.com/css2?family=${o.replace(/ /g,"+")}:wght@400;500;600;700&display=swap`,document.head.appendChild(d)}render(){if(!this.config?.schema)return;if(this.isSubmitted){this.container.innerHTML="";let l=this.config.settings?.successMessage||"Form submitted successfully!";this.container.appendChild(B(l));return}let e={...this.config.schema.styling,...this.config.styling},a={...this.config.schema,styling:e},o=I(a,this.values,this.errors,{honeypot:this.config.settings?.honeypot,showBranding:this.config.branding?.enabled!==!1,brandingText:this.config.branding?.text,brandingUrl:this.config.branding?.url,submitText:e.buttonText||this.options.submitText,isLoading:this.isLoading,hideRequiredAsterisk:e.hideRequiredAsterisk,formName:this.config.hostedConfig?.pageTitle||this.config.name,showFormName:this.config.settings?.showFormName,secondaryButton:e.secondaryButton,buttonAlign:e.buttonAlign,buttonClassName:e.buttonClassName,formNameFontSize:e.formNameFontSize,formNameFontWeight:e.formNameFontWeight});o.addEventListener("input",l=>{let d=l.target;d.name&&d.name!=="_hp"&&d.name!=="pageUrl"&&(d.type==="checkbox"?this.values[d.name]=d.checked:d.type==="file"?this.values[d.name]=d.multiple?d.files:d.files?.[0]:this.values[d.name]=d.value,this.errors[d.name]&&(delete this.errors[d.name],this.render()))}),o.addEventListener("submit",l=>{l.preventDefault(),this.handleSubmit()}),this.container.innerHTML="",this.container.appendChild(o)}async handleSubmit(){if(!(this.isLoading||!this.config)){this.isLoading=!0,this.errors={},this.render();try{let e=await this.sdk.submit(this.options.slug,this.values);this.isLoading=!1,this.isSubmitted=!0,this.render(),this.options.onSuccess?.(e);let a=this.options.redirectUrl||this.config.settings?.redirectUrl;a&&setTimeout(()=>{window.location.href=a},1500),this.options.resetOnSuccess&&setTimeout(()=>{this.reset()},3e3)}catch(e){this.isLoading=!1,e instanceof v?(this.errors=M(e.errors),this.options.onValidationError?.(e.errors)):this.options.onError?.(e),this.render()}}}reset(){this.values={},this.errors={},this.isLoading=!1,this.isSubmitted=!1,this.render()}renderLoading(){this.container.innerHTML=`
    ...
    `}destroy(){this.container.innerHTML="",this.styleEl?.remove(),this.styleEl=null}};function A(){document.querySelectorAll("[data-forms-expert]").forEach(e=>{let a=e.getAttribute("data-api-key"),o=e.getAttribute("data-resource-id"),l=e.getAttribute("data-forms-expert"),d=e.getAttribute("data-base-url")||void 0;if(!a||!o||!l){console.error("Forms Expert: Missing required attributes",{apiKey:!!a,resourceId:!!o,slug:!!l});return}new L({apiKey:a,resourceId:o,baseUrl:d},{target:e,slug:l,trackViews:e.getAttribute("data-track-views")==="true",submitText:e.getAttribute("data-submit-text")||void 0,resetOnSuccess:e.getAttribute("data-reset")==="true",lang:e.getAttribute("data-lang")||void 0}).init()})}typeof window<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",A):A());export{L as FormWidget,A as autoInit,M as errorsToRecord,P as generateFormStyles,T as renderField,I as renderForm,B as renderSuccess};
